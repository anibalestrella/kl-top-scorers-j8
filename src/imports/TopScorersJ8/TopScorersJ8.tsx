...
function Frame3() {
  ...
  return (
    <div className="absolute bg-[#73233e] content-stretch flex inset-[0_18.3%_0_18.95%] items-center justify-center px-[33.06px]">
      <p className="font-['HeadingNow-45Medium'] leading-[normal] not-italic relative shrink-0 text-[37.03px] text-center text-white uppercase whitespace-nowrap">{p.name}</p>
    </div>
  );
}
...
function Frame4() {
  ...
  return (
    <div className="absolute bg-white content-stretch flex inset-[0_0_0_81.7%] items-center justify-center">
      <p className="font-['HeadingNow-46Bold:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[84.63px] text-black uppercase whitespace-nowrap">{p.goals}</p>
    </div>
  );
}
...
function Group() {
  return (
    <div className="absolute inset-[5.47%_10.58%_5.43%_10.61%]" data-name="Group">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 65.6528 74.2337">
        <g id="Group">
          <path d={svgPaths.p4798900} fill="var(--fill-0, #030203)" id="Vector" />
          <path d={svgPaths.pa71e600} fill="var(--fill-0, #FDE253)" id="Vector_2" />
          <g id="Group_2">
            <path d={svgPaths.p41fc000} fill="var(--fill-0, #452F83)" id="Vector_3" />
            <path d={svgPaths.pb393f80} fill="var(--fill-0, #FDE253)" id="Vector_4" />
          </g>
          <path d={svgPaths.p16eecf00} fill="var(--fill-0, #6F569D)" id="Vector_5" />
          <path d={svgPaths.p39abaf80} fill="var(--fill-0, white)" id="Vector_6" />
          <g id="Group_3">
            <path d={svgPaths.p24a05b00} fill="var(--fill-0, white)" id="Vector_7" />
            <path d={svgPaths.p3b2fcf00} fill="var(--fill-0, white)" id="Vector_8" />
          </g>
          <g id="Group_4">
            <path d={svgPaths.p31a0600} fill="var(--fill-0, white)" id="Vector_9" />
            <path d={svgPaths.p5856100} fill="var(--fill-0, white)" id="Vector_10" />
          </g>
          <g id="Group_5">
            <path d={svgPaths.p18a3dbf0} fill="var(--fill-0, white)" id="Vector_11" />
            <path d={svgPaths.pcf76c40} fill="var(--fill-0, white)" id="Vector_12" />
          </g>
          <g id="Group_6">
            <g id="Group_7">
              <path d={svgPaths.p17dbda00} fill="var(--fill-0, #030203)" id="Vector_13" />
              <path d={svgPaths.p1607daf2} fill="var(--fill-0, #FDE253)" id="Vector_14" />
            </g>
            <path d={svgPaths.p22e7cd00} fill="var(--fill-0, #452F83)" id="Vector_15" />
            <path d={svgPaths.p28c44180} fill="url(#paint0_linear_1_1355)" id="Vector_16" />
            <path d={svgPaths.p36bc6600} fill="url(#paint1_linear_1_1355)" id="Vector_17" />
            <path d={svgPaths.p1482c200} fill="url(#paint2_linear_1_1355)" id="Vector_18" />
            <path d={svgPaths.p23d0c000} fill="url(#paint3_linear_1_1355)" id="Vector_19" />
            <path d={svgPaths.p2f9fa700} fill="url(#paint4_linear_1_1355)" id="Vector_20" />
            <path d={svgPaths.p8a62600} fill="url(#paint5_linear_1_1355)" id="Vector_21" />
            <path d={svgPaths.pc17ef80} fill="url(#paint6_linear_1_1355)" id="Vector_22" />
          </g>
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_1355" x1="17.9138" x2="15.7323" y1="11.9307" y2="2.57531">
          ...
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_1_1355" x1="10.5336" x2="6.14799" y1="15.032" y2="2.90451">
          ...
          <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_1_1355" x1="25.4912" x2="25.6945" y1="10.4914" y2="1.44579">
            <stop offset="0.32" stopColor="white" />
          ...
          <linearGradient gradientUnits="userSpaceOnUse" id="paint3_linear_1_1355" x1="33.3493" x2="33.3493" y1="13.8961" y2="1.69113">
          ...
          <linearGradient gradientUnits="userSpaceOnUse" id="paint4_linear_1_1355" x1="39.881" x2="39.881" y1="14.7417" y2="1.79765">
          ...
          <linearGradient gradientUnits="userSpaceOnUse" id="paint5_linear_1_1355" x1="46.0836" x2="48.7686" y1="15.813" y2="1.54589">
          ...
          <linearGradient gradientUnits="userSpaceOnUse" id="paint6_linear_1_1355" x1="56.1388" x2="58.1267" y1="19.3885" y2="2.63975">
...
function Group2() {
  return (
    <div className="absolute inset-[22.84%_26.55%_17.57%_26.58%]" data-name="Group">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 39.0515 49.6461">
        <g id="Group">
          <path d={svgPaths.p24c72b80} fill="var(--fill-0, #030203)" id="Vector" />
          <path d={svgPaths.p23ea2e00} fill="var(--fill-0, #6F569D)" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
...
function Group3() {
  return (
    <div className="absolute inset-[24.58%_28.12%_18.47%_28.14%]" data-name="Group">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 36.4375 47.4497">
        <g id="Group">
          <path d={svgPaths.p3a17d790} fill="var(--fill-0, #E5D89E)" id="Vector" />
          <path d={svgPaths.pd084c00} fill="var(--fill-0, #E5D89E)" id="Vector_2" />
          <g id="Group_2">
            <path d={svgPaths.p374ebb0} fill="url(#paint0_linear_1_1274)" id="Vector_3" />
            <path d={svgPaths.p3aa4e780} fill="var(--fill-0, white)" id="Vector_4" />
            <path d={svgPaths.pec78520} fill="var(--fill-0, white)" id="Vector_5" />
            <path d={svgPaths.p3c338170} fill="var(--fill-0, white)" id="Vector_6" />
            <path d={svgPaths.pc89900} fill="var(--fill-0, white)" id="Vector_7" />
            <path d={svgPaths.p35f6e200} fill="var(--fill-0, white)" id="Vector_8" />
            <path d={svgPaths.p22c52080} fill="var(--fill-0, white)" id="Vector_9" />
            <path d={svgPaths.p288ec400} fill="var(--fill-0, white)" id="Vector_10" />
            <path d={svgPaths.p6679700} fill="var(--fill-0, white)" id="Vector_11" />
            <path d={svgPaths.pe0858c0} fill="var(--fill-0, white)" id="Vector_12" />
            <path d={svgPaths.p39b7b480} fill="var(--fill-0, #6A539A)" id="Vector_13" />
            <path d={svgPaths.p35bcb880} fill="var(--fill-0, white)" id="Vector_14" />
            <path d={svgPaths.p218d6480} fill="var(--fill-0, white)" id="Vector_15" />
            <path d={svgPaths.p242e3500} fill="var(--fill-0, #6A539A)" id="Vector_16" />
            <path d={svgPaths.p38949a00} fill="var(--fill-0, white)" id="Vector_17" />
            <path d={svgPaths.p6a7900} fill="var(--fill-0, white)" id="Vector_18" />
            <path d={svgPaths.p13335140} fill="var(--fill-0, white)" id="Vector_19" />
            <path d={svgPaths.p18f48200} fill="var(--fill-0, white)" id="Vector_20" />
            <path d={svgPaths.p1c8ab800} fill="var(--fill-0, white)" id="Vector_21" />
            <path d={svgPaths.pc581880} fill="var(--fill-0, white)" id="Vector_22" />
            <path d={svgPaths.p1c00cf00} fill="var(--fill-0, white)" id="Vector_23" />
            <path d={svgPaths.p21e6400} fill="var(--fill-0, white)" id="Vector_24" />
            <path d={svgPaths.p27bd0c00} fill="var(--fill-0, #6A539A)" id="Vector_25" />
            <path d={svgPaths.p2fa34580} fill="var(--fill-0, #6A539A)" id="Vector_26" />
          </g>
          <g id="Group_3">
            <path d={svgPaths.p1ad54100} fill="var(--fill-0, #E3B23B)" id="Vector_27" />
            <path d={svgPaths.p2bddc200} fill="var(--fill-0, #8C388C)" id="Vector_28" />
            <path d={svgPaths.p27feab80} fill="var(--fill-0, #8C388C)" id="Vector_29" />
            <path d={svgPaths.p8411400} fill="var(--fill-0, #8C388C)" id="Vector_30" />
            <path d={svgPaths.p1e8749a0} fill="var(--fill-0, #8C388C)" id="Vector_31" />
            <path d={svgPaths.p16a44200} fill="var(--fill-0, #8C388C)" id="Vector_32" />
          </g>
          <g id="Group_4">
            <path d={svgPaths.p350541f0} fill="var(--fill-0, #8C388C)" id="Vector_33" />
            <path d={svgPaths.p21cbb400} fill="var(--fill-0, #8C388C)" id="Vector_34" />
            <path d={svgPaths.p1211ed00} fill="var(--fill-0, #8C388C)" id="Vector_35" />
            <path d={svgPaths.p1861b00} fill="var(--fill-0, #8C388C)" id="Vector_36" />
            <path d={svgPaths.pe2a900} fill="var(--fill-0, #E3B23B)" id="Vector_37" />
            <path d={svgPaths.p23304100} fill="var(--fill-0, #8C388C)" id="Vector_38" />
          </g>
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_1274" x1="18.2233" x2="18.2233" y1="28.6892" y2="3.6015">
...
function Group1() {
  return (
    <div className="absolute contents inset-[22.84%_26.55%_17.57%_26.58%]" data-name="Group">
      <Group2 />
      <Group3 />
    </div>
  );
...
function Frame7() {
  ...
  return (
    <div className="absolute bg-[#5c00b7] content-stretch flex inset-[0_18.3%_0_18.95%] items-center justify-center px-[33.06px]">
      <p className="font-['HeadingNow-45Medium'] leading-[normal] not-italic relative shrink-0 text-[39.67px] text-center text-white uppercase whitespace-nowrap">{p.name}</p>
    </div>
  );
}
...
function Layer() {
  return (
    <div className="absolute inset-[3.75%_18.19%_3.72%_18.23%]" data-name="Layer_1">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 52.9729 77.0864">
        <g clipPath="url(#clip0_1_1317)" id="Layer_1">
          <path d={svgPaths.p2110e200} fill="var(--fill-0, white)" id="Vector" />
          <path d={svgPaths.p31c22e80} fill="var(--fill-0, #F7378D)" id="Vector_2" />
          <path d={svgPaths.p4048b00} fill="var(--fill-0, #F7378D)" id="Vector_3" />
        </g>
        <defs>
...
function Frame9() {
  ...
  return (
    <div className="absolute bg-[#ff5a00] content-stretch flex inset-[0_18.3%_0_18.95%] items-center justify-center px-[33.06px]">
      <p className="font-['HeadingNow-45Medium'] leading-[normal] not-italic relative shrink-0 text-[34.7px] text-center text-white uppercase whitespace-nowrap">{p.name}</p>
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[17.226px] items-start left-[517px] top-[367px]">
      <div className="h-[83.312px] relative shrink-0 w-[505.825px]" data-name="01 SPAIN/KINGS/Social Media/Ranking">
        <Frame3 />
        <Frame4 />
        <div className="absolute inset-[0_76.21%_0_0] overflow-clip" data-name="01 SPAIN/KINGS/Side/Local">
          <div className="absolute inset-[0_0_0_9.89%]">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 108.438 83.3123">
              <path d={svgPaths.p1f5df9c0} fill="var(--fill-0, #73233E)" id="Rectangle 66" />
            </svg>
          </div>
          <div className="absolute inset-[0_83.52%_0_0]">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.8363 83.3123">
              <path d={svgPaths.p28c04500} fill="var(--fill-0, #401322)" id="Rectangle 67" />
            </svg>
          </div>
          <div className="absolute inset-[0_9.89%_0_20.88%]" data-name="KINGS ESP">
            <div className="absolute inset-[1.8%_7.74%_1.86%_7.7%]" data-name="KL/ESP/ULT/COLOR">
      ...
      <div className="h-[83.312px] relative shrink-0 w-[505.825px]" data-name="01 SPAIN/KINGS/Social Media/Ranking">
        ...
        <div className="absolute inset-[0_76.21%_0_0] overflow-clip" data-name="01 SPAIN/KINGS/Side/Local">
          <div className="absolute inset-[0_0_0_9.89%]">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 108.438 83.3123">
              <path d={svgPaths.p1f5df9c0} fill="var(--fill-0, #805DE5)" id="Rectangle 66" />
            </svg>
          </div>
          <div className="absolute inset-[0_83.52%_0_0]">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.8363 83.3123">
              <path d={svgPaths.p28c04500} fill="var(--fill-0, #4D318A)" id="Rectangle 67" />
            </svg>
          </div>
          <div className="absolute inset-[-0.25%_10.68%_0.25%_20.09%]" data-name="KINGS ESP">
            <Group9 />
          </div>
        </div>
      </div>
      <div className="h-[83.312px] relative shrink-0 w-[505.825px]" data-name="01 SPAIN/KINGS/Social Media/Ranking">
        ...
        <div className="absolute inset-[0_76.21%_0_0] overflow-clip" data-name="01 SPAIN/KINGS/Side/Local">
          <div className="absolute inset-[0_0_0_9.89%]">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 108.438 83.3123">
              <path d={svgPaths.p1f5df9c0} fill="var(--fill-0, #5C00B7)" id="Rectangle 66" />
            </svg>
          </div>
          <div className="absolute inset-[0_83.52%_0_0]">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.8363 83.3123">
              <path d={svgPaths.p28c04500} fill="var(--fill-0, #3F007D)" id="Rectangle 67" />
            </svg>
          </div>
          <div className="-translate-y-1/2 absolute h-[83.312px] left-[20.33%] right-[10.44%] top-1/2" data-name="KINGS ESP">
            <Layer />
          </div>
        </div>
      </div>
      <div className="h-[83.312px] relative shrink-0 w-[505.825px]" data-name="01 SPAIN/KINGS/Social Media/Ranking">
        ...
        <div className="absolute inset-[0_76.21%_0_0] overflow-clip" data-name="01 SPAIN/KINGS/Side/Local">
          <div className="absolute inset-[0_0_0_9.89%]">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 108.438 83.3123">
              <path d={svgPaths.p1f5df9c0} fill="var(--fill-0, #FF5A00)" id="Rectangle 66" />
            </svg>
          </div>
          <div className="absolute inset-[0_83.52%_0_0]">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.8363 83.3123">
              <path d={svgPaths.p28c04500} fill="var(--fill-0, #BA4200)" id="Rectangle 67" />
            </svg>
          </div>
          <div className="absolute inset-[0_9.89%_0_20.88%]" data-name="KINGS ESP">
            <div className="absolute inset-[3.75%_17.75%_3.74%_17.75%]" data-name="KL/ESP/SAY/COLOR">
      ...
      <div className="h-[83.312px] relative shrink-0 w-[505.825px]" data-name="01 SPAIN/KINGS/Social Media/Ranking">
        ...
        <div className="absolute inset-[0_76.21%_0_0] overflow-clip" data-name="01 SPAIN/KINGS/Side/Local">
          <div className="absolute inset-[0_0_0_9.89%]">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 108.438 83.3123">
              <path d={svgPaths.p1f5df9c0} fill="var(--fill-0, #2810FC)" id="Rectangle 66" />
            </svg>
          </div>
          <div className="absolute inset-[0_83.52%_0_0]">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.8363 83.3123">
              <path d={svgPaths.p28c04500} fill="var(--fill-0, #1A0AA1)" id="Rectangle 67" />
            </svg>
          </div>
          <div className="absolute inset-[0_9.89%_0_20.88%]" data-name="KINGS ESP">
            <div className="absolute inset-[19.25%_3.9%]" data-name="KL/ESP/XBU/WHITE">
      ...
      <div className="h-[83.312px] relative shrink-0 w-[505.825px]" data-name="01 SPAIN/KINGS/Social Media/Ranking">
        ...
        <div className="absolute inset-[0_76.21%_0_0] overflow-clip" data-name="01 SPAIN/KINGS/Side/Local">
          <div className="absolute inset-[0_0_0_9.89%]">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 108.438 83.3123">
              <path d={svgPaths.p1f5df9c0} fill="var(--fill-0, #575757)" id="Rectangle 66" />
            </svg>
          </div>
          <div className="absolute inset-[0_83.52%_0_0]">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.8363 83.3123">
              <path d={svgPaths.p28c04500} fill="var(--fill-0, #404040)" id="Rectangle 67" />
            </svg>
          </div>
          <div className="absolute inset-[0_9.89%_0_20.88%]" data-name="KINGS ESP">
            <div className="absolute inset-[5.45%_20.25%_5.53%_20.25%]" data-name="KL/ESP/PIO/COLOR">
      ...
      <div className="h-[83.312px] relative shrink-0 w-[505.825px]" data-name="01 SPAIN/KINGS/Social Media/Ranking">
        ...
        <div className="absolute inset-[0_76.21%_0_0] overflow-clip" data-name="01 SPAIN/KINGS/Side/Local">
          <div className="absolute inset-[0_0_0_9.89%]">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 108.438 83.3123">
              <path d={svgPaths.p1f5df9c0} fill="var(--fill-0, #F881C8)" id="Rectangle 66" />
            </svg>
          </div>
          <div className="absolute inset-[0_83.52%_0_0]">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.8363 83.3123">
              <path d={svgPaths.p28c04500} fill="var(--fill-0, #E74CA9)" id="Rectangle 67" />
            </svg>
          </div>
          <div className="absolute inset-[0_9.89%_0_20.88%]" data-name="KINGS ESP">
            <div className="absolute inset-[2.99%_3.01%_3.01%_2.99%]" data-name="KL/ESP/LCA">
...
function Group6() {
  return (
    <div className="absolute inset-[1%_0.05%_0_0.64%] mask-position-[-0.96px_-0.95px,_0px_0px]" style={{ maskImage: `url('${imgGroup}'), url('${imgGroup1}')` }} data-name="Group">
...
function Group5() {
  return (
    <div className="absolute contents inset-[1%_0.05%_0_0.64%]" data-name="Group">
      <Group6 />
    </div>
  );
}
...
function ClipPathGroup1() {
  return (
    <div className="absolute contents inset-[1%_0.05%_0_0.64%]" data-name="Clip path group">
      <Group5 />
    </div>
  );
}
...
function ClipPathGroup() {
  return (
    <div className="absolute contents inset-[0_0_0.54%_0]" data-name="Clip path group">
      <Group4 />
    </div>
  );
}
...
export default function TopScorersJ({ players }: { players?: TopScorerRow[] } = {}) {
  return (
    ...
    <div className="bg-black relative size-full" data-name="Top Scorers_J8">
      <div className="absolute flex h-[2493px] items-center justify-center left-[-520px] top-[-675px] w-[1832px]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "19" } as React.CSSProperties}>
      ...
      <Frame2 />
      <p className="-translate-x-full absolute font-['HeadingNow-37Extrabold:Regular',sans-serif] leading-[normal] left-[calc(50%+482px)] not-italic text-[#fbb800] text-[161.241px] text-right top-[197px] uppercase whitespace-nowrap">goleadores</p>
      <Design />
      <div className="absolute h-[1810px] left-[-413px] top-[-207px] w-[1448px]" data-name="PR021583 3" />
      ...
      <div className="-translate-x-1/2 absolute bg-[#fbb800] bottom-0 content-stretch flex gap-[20px] items-center left-[calc(50%+250.59px)] px-[10px] py-[14px]" data-name="UI GLOBAL/Social Media/Line KL">
        <TextKingsLeague />
        <Frame />
        <TextKingsLeague1 />
